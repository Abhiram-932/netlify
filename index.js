  ...
  let restCountries = fetch("https://restcountries.eu/rest/v2/all")
    ...
    .then((data) => {
      ...
      let node;
        ...
        node.setAttribute("style", " background-image: linear-gradient(white,lightgreen);color:black ; font-family:Times New Roman, Times, serif; width: 17rem; margin: 3vw; height: 25rem;");
